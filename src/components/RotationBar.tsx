...
export const RotationBar: FC<{ clickLeft: () => void; clickRight: () => void }> = (props) => {
	return (
		<div className="bar-root">
			<button className="bar-button-item-l" style={{ color: "black" }} onClick={() => props.clickLeft()}>
				<RotateLeftIcon />
			</button>
			<button className="bar-button-item-r" style={{ color: "black" }} onClick={() => props.clickRight()}>
				<RotateRightIcon />
			</button>
		</div>
	)
