...
const color2Color = (ore: TFaceColor) => {
	switch (ore) {
		case "blu":
			return new Color(cssFaceColors.blu)
		case "ora":
			return new Color(cssFaceColors.ora)
		case "red":
			return new Color(cssFaceColors.red)
		case "yel":
			return new Color(cssFaceColors.yel)
		case "whi":
			return new Color(cssFaceColors.whi)
		case "gre":
			return new Color(cssFaceColors.gre)
		case "blk":
...
const getCubieMesh = (cell: Cubie) => {
	...
	let [face_F, face_L, face_R, face_U, face_D, face_B] = [cell.colorF, cell.colorL, cell.colorR, cell.colorU, cell.colorD, cell.colorB]
		.map((x) => color2Color(x))
