...
export class CubeCell {
    ...
    rotate(direction: TRotationDirection) {
        switch (direction) {
            case "F": case "B'": [this.colorU, this.colorR, this.colorD, this.colorL] = [this.colorL, this.colorU, this.colorR, this.colorD]; break
            case "B": case "F'": [this.colorU, this.colorR, this.colorD, this.colorL] = [this.colorR, this.colorD, this.colorL, this.colorU]; break
            case "U": case "D'": [this.colorF, this.colorL, this.colorB, this.colorR] = [this.colorR, this.colorF, this.colorL, this.colorB]; break
            case "D": case "U'": [this.colorF, this.colorL, this.colorB, this.colorR] = [this.colorL, this.colorB, this.colorR, this.colorF]; break
            case "L": case "R'": [this.colorF, this.colorD, this.colorB, this.colorU] = [this.colorU, this.colorF, this.colorD, this.colorB]; break
            case "R": case "L'": [this.colorF, this.colorD, this.colorB, this.colorU] = [this.colorD, this.colorB, this.colorU, this.colorF]; break
            default: return
        }
    }
